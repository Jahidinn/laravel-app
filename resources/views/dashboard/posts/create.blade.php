                    ...
                    <div class="container m-0 p-0">
                        <div class="row m-b-1 ">
                          <div class="col">
                            ...
                            <img class="img-preview img-fluid my-3 col-sm-5 p-0">
                            <div class="form-group inputDnD">
                              <label class="sr-only" for="input_image">File Upload</label>
                              <input type="file" class="form-control-file text-secondary font-weight-bold mt-2  @error('input_image') is-invalid @enderror" id="input_image" name="input_image" accept="image/*" onchange="readUrl(this);imagePreview()" data-title="Drag and drop a file">
                            </div>
                          </div>
                        </div>
                        @error('input_image')
