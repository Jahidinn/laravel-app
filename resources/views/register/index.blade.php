...
<div class="row justify-content-center mt-5">
    <div class="col-md-7">
        <main class="form-registration w-100 m-auto p-2">
            <form action="/register" method="post">
                @csrf
                <h1 class="h3 mb-3 fw-normal text-center">Ragistration Form</h1>
            ...
            <small class="d-block mt-3 text-center">Already registered? <a href="/login"><strong>Login here</strong></a></small>
          </main>
    </div>
</div>
@endsection